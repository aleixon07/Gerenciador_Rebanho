            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        ...
                        <form action="../script/cadastra.php" method="POST" class="signin-form">
                        ...
                        <p class="w-100 text-center">&mdash; Já possui conta ? &mdash;</p>
                        <div class="social d-flex text-center">
                           
                            <a href="login.php" class="px-2 py-2 ml-md-1 rounded"><span class="ion-logo-twitter mr-2"></span>
                                Logar-se</a>
                        </div>
                    </div>
                </div>
