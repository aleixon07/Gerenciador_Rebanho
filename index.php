...
<!-- Mirrored from demo.fifothemes.com/agency/index-image-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Jun 2023 18:39:26 GMT -->
<head>
      <meta charset="utf-8">
                                    ...
                                    <div class="bg-overlay">
                                          <div class="slide-content light">
                                                <div class="align-center">
                                                      ...
                                                      <h1>Sistema Gerenciador do Rebanho</h1>
                                                      <a href="#section2" class="btn btn-1">Ver Mais</a>
                                                </div>
                                          </div>
                                    </div>
                              </div>
                                                      ...
                                                      <div class="collapse navbar-collapse" id="menu">
                                                            <ul class="nav navbar-nav navbar-right">
                                                                  ...
                                                                  <li class="dropdown nav-toggle">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                              <li><a class="external" href="login/cadastro.php">Cadastrar-se</a></li>
                                                                              <li><a class="external" href="login/login.php">Logar-se</a></li>
                                                                        </ul>
                                                                  </li>
                                                            </ul>
                                                      </div>
...
<!-- Mirrored from demo.fifothemes.com/agency/index-image-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Jun 2023 18:40:47 GMT -->
</html>