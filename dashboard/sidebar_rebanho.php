...
$sql_conta = "SELECT COUNT(*) as num_rebanho FROM rebanho WHERE idProdutor ='$id'";
...
<body>
    ...
    <body id="body-pd">
        ...
        <div class="height-100 bg-light" style="margin-top: 80px;">
            ...
            <h3 class="text-center">Listagem de Rebanhos</h3>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content border border-dark border-2">
                        <div class="modal-header border-bottom border-dark" style="background-color: #5afac2;">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Adicionando Rebanho</h1>
                        </div>
                        <div class="modal-body">
                            <form action="../script/cad_rebanho.php" method="POST">
                                <input type="text" name="rebanho" class="form-control border-dark border" id="floatingInput" required placeholder="Título">
                ...
                <div class="row">
                    <table class="table w-50 col-4 border border-2 border-dark">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM rebanho WHERE idProdutor = '$id'";
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href='form_edit_rebanho.php?id=<?php echo $row["idRebanho"]; ?>' class='btn border border-dark border-opacity-25 '><i class="bi bi-pencil-fill"></i></a>

                                            <button onclick='AlertDeletRebanho(<?php echo $row["idRebanho"]; ?>)' class='btn border border-dark border-opacity-25'><i class="bi bi-trash-fill"></i></button>
                                        </td>
                                    </tr>
                        ...
                        <div class="col-2 ms-3">
                            <div class=" border border-dark border-2" style="border-radius: 25px;">
                                <h5 class="text-center border-bottom border-dark border-2 pb-2">Rebanhos Cadastrados</h5>
                                <h1 class="text-center" style="color: #35b085;"><?php echo $row_conta["num_rebanho"]; ?></h1>
                            </div>
                        </div>
                </div>
            </div>
    ...
    ?>
        <script>
            ...
            Swal.fire({
                title: "Sucesso!",
                text: "Rebanho adicionado com sucesso.",
                icon: "success"

            }).then((result) => {
                window.location.href = "sidebar_rebanho.php";
            });
        </script>
    ...
    <?php
        ...
        <script>
            ...
            Swal.fire({
                title: "Sucesso!",
                text: "Rebanho deletado com sucesso.",
                icon: "success"
    ...
    <?php  } else if ($_GET['e'] == md5(3)) { ?>
        <script>
            ...
            Swal.fire({
                title: "Sucesso!",
                text: "Rebanho editado com sucesso.",
                icon: "success"
    ...
    <?php  } else if ($_GET['e'] == md5(4)) { ?>
        <script>
            ...
            Swal.fire({
                title: "Ops!",
                text: "Não foi possível deletar o rebanho.",
                icon: "error"
    ...
    <?php  }else if ($_GET['e'] == md5(20)) { ?>
        <script>
            ...
            Swal.fire({
                title: "Atenção!",
                text: "Você não pode deletar um rebanho já cadastrado em um animal.",
                icon: "error"
        ...
        function AlertDeletRebanho(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = `../script/delet_rebanho.php?id=${id}`;
                }
            });
        }
    </script>
