...
$sql1 = "SELECT * FROM inventario WHERE idInventario ='$edit_id' AND idProdutor = '$id'";
$result1 = $conn->query($sql1);
if ($result1->num_rows > 0) {

$row1 = $result1->fetch_assoc();

$nome_inventario = $row1["Nome"];
$ano_inventario = $row1["Ano"];
}else{
    header("Location: sidebar_inventario.php");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <body id="body-pd">
        ...
        <div class="height-100 bg-light" style="margin-top: 80px;">
            ...
            <h3 class="mb-5 text-center">Edição Inventário</h3>

            <div>
                <form action="../script/edit_inventario.php" method="POST">

                    <a href="sidebar_inventario.php"><i class="bi bi-arrow-return-left"></i></a>

                    <h4>Formulário de Edição</h4>
                    <div class="row form-row">
                        <div class="col-6">
                            <label for="nome">Nome</label>
                            <input type="text" id="nome" name="nome" required value="<?php echo $nome_inventario; ?>">
                        </div>
                        <div class="col-6">
                            <label for="nome">Ano</label>
                            <input type="number" id="ano" name="ano" required value="<?php echo $ano_inventario; ?>">
                        </div>
