...
$sql_conta = "SELECT COUNT(*) as num_invetario FROM inventario WHERE idProdutor = '$id'" ;
...
<body>
    ...
    <body id="body-pd">
        ...
        <div class="height-100 bg-light" style="margin-top: 80px;">
            ...
            <h3 class="text-center">Listagem de Inventários</h3>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content border border-dark border-2">
                        <div class="modal-header border-bottom border-dark" style="background-color: #5afac2;">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Adicionando Inventário</h1>
                        </div>
                        <div class="modal-body">
                            <form action="../script/cad_inventario.php" method="POST">
                                <input type="text" name="inventario" class="form-control border-dark border mb-4" id="floatingInput" required placeholder="Título">
                                <input type="number" name="ano" class="form-control border-dark border" id="floatingInput" required placeholder="Ano">
                ...
                <div class="row">
                    <table class="table w-50 col-5 border border-2 border-dark">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM inventario  WHERE idProdutor = '$id'";
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href='form_edit_inventario.php?id=<?php echo $row["idInventario"]; ?>' class='btn border border-dark border-opacity-25 '><i class="bi bi-pencil-fill"></i></a>
                                            
                                            <button onclick='AlertDeletInventario(<?php echo $row["idInventario"]; ?>)' class='btn border border-dark border-opacity-25'><i class="bi bi-trash-fill"></i></button>
                                        </td>
                                    </tr>
                    ...
                    <div class="col-2 ms-3">
                        <div class=" border border-dark border-2" style="border-radius: 25px;">
                            <h5 class="text-center border-bottom border-dark border-2 pb-2">Inventários Cadastrados</h5>
    ...
    ?>
        <script>
            ...
            Swal.fire({
                ...
                window.location.href = "sidebar_inventario.php";
            });
        </script>
        ...
        function AlertDeletInventario(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = `../script/delet_inventario.php?id=${id}`;
                }
            });
        }
    </script>
